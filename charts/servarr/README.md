...
| `jellyfin.priorityClassName`                    | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                                                                                         | `""`                           |
| `jellyfin.nodeSelector`                         | The node selector to use for the pod.                                                                                                                                                                              | `{}`                           |
| `jellyfin.podLabels`                            | Additional labels to add to the pod template.                                                                                                                                                                      | `{}`                           |
| `jellyfin.tolerations`                          | The tolerations to use for the pod.                                                                                                                                                                                | `[]`                           |
| `jellyfin.topologySpreadConstraints`            | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains.                                                                      | `[]`                           |
...
| `jellyfin.startupProbe.enabled`                 | Whether to enable the startup probe.                                                                                                                                                                               | `false`                        |
...
| `sonarr.startupProbe`                                  | Startup probe configuration.                                                                                                                  | `{}`                         |
| `sonarr.livenessProbe`                                 | Liveness probe configuration.                                                                                                                 | `{}`                         |
| `sonarr.readinessProbe`                                | Readiness probe configuration. Leave empty to disable.                                                                                        | `{}`                         |
...
| `sonarr.priorityClassName`                             | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                    | `""`                         |
| `sonarr.nodeSelector`                                  | The node selector to use for the pod.                                                                                                         | `{}`                         |
| `sonarr.podLabels`                                     | Additional labels to add to the pod template.                                                                                                 | `{}`                         |
| `sonarr.tolerations`                                   | The tolerations to use for the pod.                                                                                                           | `[]`                         |
| `sonarr.topologySpreadConstraints`                     | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains. | `[]`                         |
...
| `qbittorrent.service.bt.containerPort`                      | The container port to use for the service.                                                                                                    | `6881`                            |
...
| `qbittorrent.startupProbe`                                  | Startup probe configuration. Leave empty to disable.                                                                                          | `{}`                              |
| `qbittorrent.livenessProbe`                                 | Liveness probe configuration. Leave empty to disable.                                                                                         | `{}`                              |
| `qbittorrent.readinessProbe`                                | Readiness probe configuration. Leave empty to disable.                                                                                        | `{}`                              |
...
| `qbittorrent.priorityClassName`                             | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                    | `""`                              |
| `qbittorrent.nodeSelector`                                  | The node selector to use for the pod.                                                                                                         | `{}`                              |
| `qbittorrent.podLabels`                                     | Additional labels to add to the pod template.                                                                                                 | `{}`                              |
| `qbittorrent.tolerations`                                   | The tolerations to use for the pod.                                                                                                           | `[]`                              |
| `qbittorrent.topologySpreadConstraints`                     | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains. | `[]`                              |
...
| `prowlarr.startupProbe`                                  | Startup probe configuration.                                                                                                                  | `{}`                           |
| `prowlarr.livenessProbe`                                 | Liveness probe configuration.                                                                                                                 | `{}`                           |
| `prowlarr.readinessProbe`                                | Readiness probe configuration. Leave empty to disable.                                                                                        | `{}`                           |
...
| `prowlarr.priorityClassName`                             | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                    | `""`                           |
| `prowlarr.nodeSelector`                                  | The node selector to use for the pod.                                                                                                         | `{}`                           |
| `prowlarr.podLabels`                                     | Additional labels to add to the pod template.                                                                                                 | `{}`                           |
| `prowlarr.tolerations`                                   | The tolerations to use for the pod.                                                                                                           | `[]`                           |
| `prowlarr.topologySpreadConstraints`                     | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains. | `[]`                           |
...
| `flaresolverr.startupProbe`                                  | Startup probe configuration. Leave empty to disable.                                                                                          | `{}`                                |
| `flaresolverr.livenessProbe`                                 | Liveness probe configuration. Leave empty to disable.                                                                                         | `{}`                                |
| `flaresolverr.readinessProbe`                                | Readiness probe configuration. Leave empty to disable.                                                                                        | `{}`                                |
...
| `flaresolverr.priorityClassName`                             | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                    | `""`                                |
| `flaresolverr.nodeSelector`                                  | The node selector to use for the pod.                                                                                                         | `{}`                                |
| `flaresolverr.podLabels`                                     | Additional labels to add to the pod template.                                                                                                 | `{}`                                |
| `flaresolverr.tolerations`                                   | The tolerations to use for the pod.                                                                                                           | `[]`                                |
| `flaresolverr.topologySpreadConstraints`                     | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains. | `[]`                                |
...
| `seerr.image.tag`                                     | The image tag to use.                                                                                                                         | `latest`                   |
...
| `seerr.securityContext`                               | The security context to use for the container.                                                                                                | `{}`                       |
| `seerr.initContainers`                                | Additional init containers to add to the pod.                                                                                                 | `[]`                       |
| `seerr.service.type`                                  | The type of service to create.                                                                                                                | `ClusterIP`                |
...
| `seerr.startupProbe`                                  | Startup probe configuration. Leave empty to disable.                                                                                          | `{}`                       |
| `seerr.livenessProbe`                                 | Liveness probe configuration. Leave empty to disable.                                                                                         | `{}`                       |
| `seerr.readinessProbe`                                | Readiness probe configuration. Leave empty to disable.                                                                                        | `{}`                       |
...
| `seerr.priorityClassName`                             | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                    | `""`                       |
| `seerr.nodeSelector`                                  | The node selector to use for the pod.                                                                                                         | `{}`                       |
| `seerr.podLabels`                                     | Additional labels to add to the pod template.                                                                                                 | `{}`                       |
| `seerr.tolerations`                                   | The tolerations to use for the pod.                                                                                                           | `[]`                       |
| `seerr.topologySpreadConstraints`                     | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains. | `[]`                       |
...
| `bazarr.startupProbe`                                  | Startup probe configuration. Leave empty to disable.                                                                                          | `{}`                         |
| `bazarr.livenessProbe`                                 | Liveness probe configuration. Leave empty to disable.                                                                                         | `{}`                         |
| `bazarr.readinessProbe`                                | Readiness probe configuration. Leave empty to disable.                                                                                        | `{}`                         |
...
| `bazarr.priorityClassName`                             | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                    | `""`                         |
| `bazarr.nodeSelector`                                  | The node selector to use for the pod.                                                                                                         | `{}`                         |
| `bazarr.podLabels`                                     | Additional labels to add to the pod template.                                                                                                 | `{}`                         |
| `bazarr.tolerations`                                   | The tolerations to use for the pod.                                                                                                           | `[]`                         |
| `bazarr.topologySpreadConstraints`                     | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains. | `[]`                         |
...
| `radarr.startupProbe`                                  | Startup probe configuration.                                                                                                                  | `{}`                         |
| `radarr.livenessProbe`                                 | Liveness probe configuration.                                                                                                                 | `{}`                         |
| `radarr.readinessProbe`                                | Readiness probe configuration. Leave empty to disable.                                                                                        | `{}`                         |
...
| `radarr.priorityClassName`                             | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                    | `""`                         |
| `radarr.nodeSelector`                                  | The node selector to use for the pod.                                                                                                         | `{}`                         |
| `radarr.podLabels`                                     | Additional labels to add to the pod template.                                                                                                 | `{}`                         |
| `radarr.tolerations`                                   | The tolerations to use for the pod.                                                                                                           | `[]`                         |
| `radarr.topologySpreadConstraints`                     | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains. | `[]`                         |
...
| `lidarr.startupProbe`                                  | Startup probe configuration.                                                                                                                  | `{}`                         |
| `lidarr.livenessProbe`                                 | Liveness probe configuration.                                                                                                                 | `{}`                         |
| `lidarr.readinessProbe`                                | Readiness probe configuration. Leave empty to disable.                                                                                        | `{}`                         |
...
| `lidarr.priorityClassName`                             | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                    | `""`                         |
| `lidarr.nodeSelector`                                  | The node selector to use for the pod.                                                                                                         | `{}`                         |
| `lidarr.podLabels`                                     | Additional labels to add to the pod template.                                                                                                 | `{}`                         |
| `lidarr.tolerations`                                   | The tolerations to use for the pod.                                                                                                           | `[]`                         |
| `lidarr.topologySpreadConstraints`                     | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains. | `[]`                         |
...
| `cleanuparr.startupProbe`                                  | Startup probe configuration. Leave empty to disable.                                                                                          | `{}`                            |
| `cleanuparr.livenessProbe`                                 | Liveness probe configuration. Leave empty to disable.                                                                                         | `{}`                            |
| `cleanuparr.readinessProbe`                                | Readiness probe configuration. Leave empty to disable.                                                                                        | `{}`                            |
...
| `cleanuparr.priorityClassName`                             | Kubernetes PriorityClass name for pod eviction priority. Leave empty to inherit the cluster's globalDefault PriorityClass.                    | `""`                            |
| `cleanuparr.nodeSelector`                                  | The node selector to use for the pod.                                                                                                         | `{}`                            |
| `cleanuparr.podLabels`                                     | Additional labels to add to the pod template.                                                                                                 | `{}`                            |
| `cleanuparr.tolerations`                                   | The tolerations to use for the pod.                                                                                                           | `[]`                            |
| `cleanuparr.topologySpreadConstraints`                     | Control how pods are spread across your cluster among failure-domains such as regions, zones, nodes, and other user-defined topology domains. | `[]`                            |
